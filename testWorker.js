...
function T(exp){
    ...
    //postMessage(exp);
    var arrFunc = ['element_Express]DDD[element_Express','dragElement','style_Group]DDD[style_Express','preventPullToRefresh','addEventListenerOther','ScanBarcode','jsBar','jsQr','Getuuid','onclick_Express','autoResize_Express'];
